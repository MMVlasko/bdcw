...
from .views import HabitViewSet, HabitLogViewSet, BatchHabitCreateView, BatchHabitLogCreateView
...
urlpatterns = [
    ...
    path('log/habit/<int:habit_id>/', HabitLogViewSet.as_view({'get': 'habit_logs'}),
         name='log-by-habit'),
    path('batch-import/', BatchHabitCreateView.as_view(),
         name='batch-habit-create'),
    path('log/batch-import/', BatchHabitLogCreateView.as_view(),
         name='batch-habit-log-create')
]
